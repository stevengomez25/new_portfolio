        ...
        <div className="h-dvh w-full flex flex-col">
            ...
            <div id="education" className="md:pt-2 text-3xl h-5/6 w-full flex flex-col  md:grid md:grid-cols-2 md:gap-x-2 place-items-center ">
                <div className="h-2/3 w-9/10 bg-sky-900 shadow-2xl shadow-white text-white hover:scale-105 hover:text-shadow-lg/30 flex flex-col items-start justify-center border-2 border-black rounded-md">
                    ...
                    <p className="px-3 text-base md:text-4xl">Architectural drawing technician</p>
                ...
                <div className="h-2/3 w-9/10 bg-sky-900 shadow-2xl shadow-white text-white hover:scale-105 hover:text-shadow-lg/30 flex flex-col items-start justify-center border-2 border-black rounded-md">
                    ...
                    <p className="px-3 text-base md:text-4xl text-clip">Technology in software</p>
                    <p className="px-3 text-base md:text-4xl text-clip">analysis and development </p>
                    ...
                    <h2 className="px-3 text-sm md:text-base">Udemy Learning Platform</h2>
                    <p className="px-3 text-base md:text-4xl">HTML, CSS5, Javascript (Advanced)</p>
                    ...
                    <p className="px-3 text-base md:text-4xl">Software architecture - SQL/noSQL - project management - planning, development and execution</p>
                    <p className="px-3 text-sm md:text-base">2021 - ongoing</p>
                </div>
            </div>
